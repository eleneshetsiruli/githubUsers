...
export const Card = ({ data, darkMode }: CardProps) => {
  const whiteColor = darkMode ? "white" : "";
  const lightTypography = darkMode ? "darkMode" : "lightTypography";
  return (
    <>
      <div className={darkMode ? "rightSide dark" : ""}>
        <div className="info">
          ...
          <div>
            <p className={lightTypography}>repos</p>
            <span>{data.public_repos}</span>
          </div>
          <div>
            <p className={lightTypography}>followers</p>
            <span>{data.followers}</span>
          </div>
          <div>
            <p className={lightTypography}>following</p>
            <span>{data.following}</span>
          </div>
        </div>

        <div className="minuIcons">
          <div className="mini">
            <p className={lightTypography}>
              ...
              <span className={whiteColor}> Company</span>
            </p>
          ...
          <div className="mini">
            <p className={lightTypography}>
              ...
              <span className={whiteColor}> Link</span>
            </p>
            <span className={whiteColor}>{data.subscriptions_url}</span>
          </div>
          <div className="mini">
            <p className={lightTypography}>
              ...
              <span className={whiteColor}> Tweet</span>
            </p>
            <span className={whiteColor}>
          ...
          <div className="mini">
            <p className={lightTypography}>
              ...
              <span className={whiteColor}> Github</span>
            </p>
            <span className={whiteColor}>{data.html_url}</span>
          </div>
        </div>
      </div>
    </>
